...
@Component({
  selector: 'app-accepted-leave-notification-hr',
  templateUrl: './accepted-leave-notification-hr.component.html',
  styleUrls: ['./accepted-leave-notification-hr.component.scss']
})
export class AcceptedLeaveNotificationHrComponent implements OnInit {
