...
import { ServicesService } from "src/app/services/services.service";
@Component({
  selector: 'app-all-leave-notification-hr',
  templateUrl: './all-leave-notification-hr.component.html',
  styleUrls: ['./all-leave-notification-hr.component.scss']
})
export class AllLeaveNotificationHrComponent implements OnInit {
